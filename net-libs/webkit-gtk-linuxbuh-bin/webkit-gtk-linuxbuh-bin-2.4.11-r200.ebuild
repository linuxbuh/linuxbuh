...
SRC_URI="abi_x86_32? ( $DOWNLOADPAGE/webkit-gtk-linuxbuh-bin-2.4.11-r200.i686.tar.gz )
	abi_x86_64? ( $DOWNLOADPAGE/webkit-gtk-linuxbuh-bin-2.4.11-r200.amd64.tar.gz )"
