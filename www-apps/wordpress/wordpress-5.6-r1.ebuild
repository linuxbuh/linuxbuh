...
SRC_URI="https://ru.wordpress.org/latest-ru_RU.tar.gz"
...
src_install() {
	...
	webapp_postinst_txt en "${FILESDIR}"/postinstall-ru.txt
	webapp_postupgrade_txt en "${FILESDIR}"/postupgrade-ru.txt
