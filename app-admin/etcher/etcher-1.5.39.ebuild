...
SRC_URI="x86? ( https://github.com/balena-io/etcher/releases/download/v1.5.39/balena-etcher-electron-1.5.39-linux-ia32.zip )
    amd64? ( https://github.com/balena-io/etcher/releases/download/v1.5.39/balena-etcher-electron-1.5.39-linux-x64.zip )
    "
